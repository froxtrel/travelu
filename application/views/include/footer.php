							...
							<div class="tg-footercolumn tg-widget tg-widgettext">
								...
								<div class="tg-widgetcontent">
									<div class="tg-description">
										<p>Formely known as Borneowavehunters

We offer value-for-money White Water Rafting and Sea Adventure Kayaking packages in Sabah, Borneo</p>
									</div>
									<span>+6 088-201000</span>
									<a href="mailto:info@borneowavehunters.com">info@borneowavehunters.com</a>
						...
						<div class="col-xs-6 col-sm-6 col-md-3 col-lg-3">
							<div class="tg-footercolumn tg-widget tg-widgettravelunews">
								<div class="tg-widgettitle">
									<h3>Wavehunterasia News</h3>
								</div>
								<div class="tg-widgetcontent">
									<ul>
										<li>
											<figure>
												<a href="javascript:void(0);"><img src="<?= base_url();?>public/images/thumbnail/img-01.jpg" alt="image destinations"></a>
											</figure>
										...
										<li>
											<figure>
												<a href="javascript:void(0);"><img src="<?= base_url();?>public/images/thumbnail/img-02.jpg" alt="image destinations"></a>
											</figure>
											<div class="tg-newcontent">
						...
						<div class="col-xs-6 col-sm-6 col-md-3 col-lg-3">
							<div class="tg-footercolumn tg-widget tg-widgetdestinations">
								...
								<div class="tg-widgetcontent">
									<p> Lot E-4-1(B), Block E, 4th Floor, Plaza Tanjung Aru, 88100 Kota Kinabalu</p>
									<hr>
								</div>
								<div class="tg-widgettitle">
									<h3>How to pay</h3>
						...
						<div class="col-xs-6 col-sm-6 col-md-3 col-lg-3">
							<div class="tg-footercolumn tg-widget tg-widgetnewsletter">
								<div class="tg-widgettitle">
									<h3>Verify Promotional Code</h3>
								</div>
								<div class="tg-widgetcontent">
									<form class="tg-formtheme tg-formnewsletter">
										<fieldset>
											<input type="email" name="email" class="form-control" placeholder="Your Promo Code">
											<button type="submit"><img src="<?= base_url();?>public/images/icons/icon-08.png" alt="image destinations"></button>
										</fieldset>
									</form>
								</div>
							</div>
				...
				<div class="container">
					<div class="row">
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							<p>Copyright &copy; 2018 Wavehunterasia. All  rights reserved</p>
						</div>
					</div>
				</div>
			</div>
	...
	*************************************-->
	...
	<script src="<?= base_url();?>public/js/jquery-scrolltofixed.js"></script>
	<script src="<?= base_url();?>public/js/owl.carousel.min.js"></script>
	<script src="<?= base_url();?>public/js/jquery.mmenu.all.js"></script>
	<script src="<?= base_url();?>public/js/packery.pkgd.min.js"></script>
	<script src="<?= base_url();?>public/js/jquery.vide.min.js"></script>
	<script src="<?= base_url();?>public/js/scrollbar.min.js"></script>
	<script src="<?= base_url();?>public/js/prettyPhoto.js"></script>
	<script src="<?= base_url();?>public/js/countdown.js"></script>
	<script src="<?= base_url();?>public/js/parallax.js"></script>
	<script src="<?= base_url();?>public/js/gmap3.js"></script>
