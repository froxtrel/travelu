				...
				<div class="row">
					<div class="tg-topbar">
						<nav class="tg-infonav">
							<ul>
								<li>
									<i><img src="<?= base_url();?>public/images/icons/icon-01.png" alt="image destinations"></i>
									<span>+6 088-201000</span>
								</li>
								<li>
									<i><img src="<?= base_url();?>public/images/icons/icon-02.png" alt="image destinations"></i>
									<span>DISCOVER DIFFERENT TYPE OF TOUR VISIT : <a href="javascript:void(0);"> Travelmateholidays</a></span>
								</li>
							</ul>
						</nav>
						<div class="tg-addnavcartsearch">
							<nav class="tg-addnav">
								<ul>
								    <li><a href="<?=base_url();?>welcome/facebook">facebook</a></li>
							...
							<nav class="tg-cartsearch">
								<ul>
									<!-- <li>
										<a href="javascript:void(0);"><img src="<?= base_url();?>public/images/icons/icon-03.png" alt="image destinations"></a>
										<div class="tg-cartitems">
											<div class="tg-cartlistitems">
												<h3>Shopping Cart</h3>
												<div class="tg-cartitem">
													<figure class="tg-itemimg"><img src="<?= base_url();?>public/images/products/img-11.jpg" alt="image description"></figure>
									...
									<li><a href="#tg-search"><img src="<?= base_url();?>public/images/icons/icon-04.png" alt="image destinations"></a></li>
								</ul>
							</nav>
						</div>
					</div>
					<div class="tg-navigationarea tg-headerfixed">
						<strong class="tg-logo"><a href="index.html"><img src="<?= base_url();?>public/images/wavehunterlogo.png" alt="company logo here"></a></strong>
							...
							<div class="tg-userbox">
								...
								<div class="dropdown tg-dropdown">
									<button class="tg-btndropdown" id="tg-dropdowndashboard" type="button" data-toggle="dropdown">
										<img src="<?= base_url();?>public/images/author/img-01.jpg" alt="image description">
						...
						<nav id="tg-nav" class="tg-nav">
							...
							<div id="tg-navigation" class="collapse navbar-collapse tg-navigation">
								<ul>
									...
									<li class="menu-item-has-children menu-item-has-mega-menu"><a href="javascript:void(0);">Tour</a></li>
									<!-- <li><a href="destinations.html">destinations</a></li> -->
									<li class="menu-item-has-children menu-item-has-mega-menu"><a href="<?= base_url();?>welcome/listing/rafting">Rafting</a>
										<div class="mega-menu">
											<ul>
									...
									<!-- <li><a href="destinations.html">destinations</a></li> -->
									<li class="menu-item-has-children menu-item-has-mega-menu"><a href="<?= base_url();?>welcome/listing/kayaking">Sea Kayaking</a>
										<div class="mega-menu">
											<ul>
												<li><a href="listingvone.html">list style one</a></li>
												<li><a href="listingvtwo.html">list style two</a></li>
